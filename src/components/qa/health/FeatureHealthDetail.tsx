...
import { ExternalLink, HelpCircle, ShieldCheck, X } from "lucide-react";
          ...
          {isAdmin && !data.isCleared && (
            <Tooltip>
              ...
              <TooltipContent side="top" className="max-w-64 text-xs">
                Mark this feature as manually reviewed and approved by admin. This status auto-reverts if a new bug is reported.
              </TooltipContent>
            </Tooltip>
          )}
        </div>
